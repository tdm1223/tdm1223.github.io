---
title:  "백준 17143. 낚시왕"
excerpt: "https://www.acmicpc.net/problem/17143"
categories:
  - Algorithm
tags:
  - Algorithm
  ...
  - 백준
  - acmicpc
last_modified_at: 2020-02-25T08:06:00-00:00
sitemap :
    changefreq : daily
    priority : 1.0
toc: true
...
- 정렬을 편하게 하기 위해 **상어 구조체**를 만들고 **크기순**, **번호순**으로 정렬하기 위한 compare함수를 선언하였다.

### 풀이 과정
1. 낚시왕이 **오른쪽**으로 한 칸 이동한다.
2. 낚시왕이 있는 열에 있는 상어 중에서 **가장 땅과 가까운 상어**를 잡는다. 이때, 상어를 잡으면 잡힌 상어는 **격자판에서 사라진다**.
3. **상어를 이동**시킨다.
4. 1~3과정을 낚시왕이 맨 끝 자리로 이동할때까지 반복한다.
...
```
[전체 소스 코드](https://github.com/tdm1223/Algorithm/blob/master/acmicpc.net/source/17143.cpp)